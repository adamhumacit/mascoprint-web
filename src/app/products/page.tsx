...
const products = [
  {
    ...
    images: [
      '/images/products/cp12-2.webp',
      '/images/products/cp12-1.webp',
      '/images/products/cp12-3.webp',
  ...
  },
  {
    ...
    models: [
      { name: 'TG150', image: '/images/products/tg150.webp' },
      { name: 'TG30', image: '/images/products/tg30.webp' },
      { name: 'TG80135', image: '/images/products/tg80135.webp' },
      { name: 'TG80', image: '/images/products/tg80.webp' },
    ],
    images: [
      '/images/products/tg150.webp',
      '/images/products/tg30.webp',
      '/images/products/tg80135.webp',
      '/images/products/tg80.webp',
    ],
    videoUrl: null,
    datasheetUrl: null,
  },
